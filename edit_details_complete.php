...
$qry1 = "UPDATE ecommerce SET product = '".$product."', size= '".$size."', price= '".$price."', color='".$color."', description='".$description."', catagory= '".$catagory."',style = '".$style."', brand= '".$brand."', count= '".$count."'  WHERE id='".$pid."'" or die(mysql_error());
