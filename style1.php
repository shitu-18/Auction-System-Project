...
$rew=mysql_query($q);?><table><tr><?
while($row=mysql_fetch_array($rew))
{?><td><?
 $st="upload/".$row['image'];
 echo"<div align='left'>";
 echo "<img src =$st width=150 height=150>";echo"</div>";?></td><td><?php // echo $row['description'];?></td></tr><tr><td><? //echo $row['name'];?></td><td><? //echo $row['price'];?> </tr>
<? }?></table>
<style type="text/css">
<!--
