...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr bgcolor="#E4EDEC">
    ...
    <td bgcolor="#E4EDEC"><span class="style1"><?php echo $id?></span></td>
     <td><span class="style1"><?php echo $fname; ?></span></td>
     <td><span class="style1"><?php echo $lname; ?></span></td>
    <td><span class="style1"><?php echo $email; ?></span></td>
	<td><span class="style1"><?php echo $password; ?></span></td>
	<td><span class="style1"><?php echo $country; ?></span></td>
    <td><span class="style1"><?php echo $gender; ?></span></td>
    <td><span class="style1"><a href="delete.php?id=<?php echo $id; ?>">Delete</a></span></td>
    <td><form action="status.php" method="post">
	
    <input type="hidden" name="id" id="id" value="<?php echo $res1['id'];?>" />
    <input type="submit" value="active" name="submit"/>
    <input type="submit" value="notactive" name="submit2"/>
    </form>
    </tr>
  <?php
  }
